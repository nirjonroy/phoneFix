...
class HomePageController extends Controller
{
    ...
    {
        if(!auth()->user()->can('popularCategory.index')){
    ...
    public function storePopularCategory(Request $request)
    {
        ...
        PopularCategory::create(['category_id' => $request->category_id, 'priority' => $request->priority]);
    ...
    {
        if(!auth()->user()->can('popularCategory.delete')){
            abort(403, 'Unauthorized action.');
        }  
    ...
    {
        if(!auth()->user()->can('featuredCategory.index')){
            abort(403, 'Unauthorized action.');
        }
    ...
    {
        if(!auth()->user()->can('featuredCategory.delete')){
            abort(403, 'Unauthorized action.');
        }
