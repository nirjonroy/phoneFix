                        ...
                        <form action="{{ route('admin.blog.update',$blog->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="meta_description" cols="30" rows="5" class="form-control text-area-5">{{ $blog->meta_description }}</textarea>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    @if ($blog->meta_image)
                                        <div class="mt-2">
                                            <img src="{{ asset($blog->meta_image) }}" alt="Meta image" style="max-height: 160px;">
                                        </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" class="form-control" name="publisher" value="{{ $blog->publisher }}">
                                </div>

                                <div class="form-group col-6">
                                    <label>Meta Copyright</label>
                                    <input type="text" class="form-control" name="copyright" value="{{ $blog->copyright }}">
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="keywords" cols="30" rows="3" class="form-control text-area-5">{{ $blog->keywords }}</textarea>
                                </div>
